        ...
        (i = [
          {
            ...
            value: function() {
              (this.group = new THREE.Object3D()),
                ...
                (this.gridSize = 40),
                (this.buildings = []),
                (this.fogConfig = { color: "#353c3c", near: 1, far: 208 }),
          ...
          },
          {
            ...
            value: function() {
              var t = this,
                ...
                i = new THREE.MeshPhysicalMaterial({ color: "#fff" });
              (this.backgroundShape = new THREE.Mesh(e, i)),
                  ...
                  getMousePos: function(t, e) {
                    ...
                    return (
                      ...
                      t.pageX || t.pageY
                        ? ((i = t.pageX), (n = t.pageY))
                        : (t.clientX || t.clientY) &&
                          ((i = t.clientX + e.left), (n = t.clientY + e.top)),
                      { x: i, y: n }
                    );
                  },
                  lerp: function(t, e, i) {
                ...
                window.addEventListener("mousemove", function(e) {
                  var i = {
                      left:
                        t.tiltFx.body.scrollLeft + t.tiltFx.docEl.scrollLeft,
                ...
                window.addEventListener("resize", function() {
                  return (t.docheight = Math.max(
                    t.tiltFx.body.scrollHeight,
                    t.tiltFx.body.offsetHeight,
                    t.tiltFx.docEl.clientHeight,
                    t.tiltFx.docEl.scrollHeight,
                    t.tiltFx.docEl.offsetHeight
                  ));
                }),
          ...
          },
          {
            ...
            value: function() {
              ...
              (this.lastMouseY = this.tiltFx.lerp(
                this.lastMouseY,
                this.tiltFx.lineEq(0, 65, this.docheight, 0, e),
                0.05
              )),
                (this.lastScale = this.tiltFx.lerp(
                  this.lastScale,
                  this.tiltFx.lineEq(0, 158, this.docheight, 0, e),
                  0.05
                )),
          ...
          },
          {
            ...
            value: function() {
              this.sortBuildingsByDistance(),
                this.buildings.forEach(function(t, e) {
                  TweenMax.to(t.position, 0.6 + e / 4e3, {
                    y: 1,
                    ease: Quint.easeOut,
                    delay: e / 4e3
                  });
          ...
          },
          {
            ...
            value: function() {
              for (
                var t = new THREE.MeshPhysicalMaterial({
                    color: "#000",
                    metalness: 0,
                    emissive: "#000",
                    roughness: 0.77
                ...
                for (var i = 0; i < this.gridSize; i++) {
                  ...
                  (n.material = t),
                    (n.scale.y = Math.random() * (0.008 + 0.01)),
                    (n.position.x = 3 * e),
                    (n.position.z = 3 * i),
                    this.group.add(n),
